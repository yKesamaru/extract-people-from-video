...
![](img/PASTE_IMAGE_2023-08-11-11-00-24.png)
...
BoxMOT: pluggable SOTA tracking modules for object detectors. Yolov8, YoloX, YoloNAS supported. SOTA CLIP-ReID models available!!
  <p>
  <img src="https://raw.githubusercontent.com/yKesamaru/extract-people-from-video/master/assets/images/track_all_seg_1280_025conf.gif" width="400"/>
  </p>
...
実行結果は`/home/terms/ドキュメント/extract people from video/runs/track/exp`に`avi形式`で保存されます。
  ...
  <p>
  <img src="https://raw.githubusercontent.com/yKesamaru/extract-people-from-video/master/assets/deepsort.gif" />
  </p>
...
```
  ...
  <p>
  <img src="https://raw.githubusercontent.com/yKesamaru/extract-people-from-video/master/assets/deep_oc-sort.gif" />
  </p>
...
```
  ...
  <p>
  <img src="https://raw.githubusercontent.com/yKesamaru/extract-people-from-video/master/assets/deep_oc-sort_alpha.gif" />
  </p>
